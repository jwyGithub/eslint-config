...
type ConfigNames = 'jiangweiye/astro/setup' | 'jiangweiye/astro/rules' | 'jiangweiye/eslint-comments/rules' | 'jiangweiye/formatter/setup' | 'jiangweiye/imports/rules' | 'jiangweiye/javascript/setup' | 'jiangweiye/javascript/rules' | 'jiangweiye/jsx/setup' | 'jiangweiye/jsdoc/rules' | 'jiangweiye/jsonc/setup' | 'jiangweiye/jsonc/rules' | 'jiangweiye/markdown/setup' | 'jiangweiye/markdown/processor' | 'jiangweiye/markdown/parser' | 'jiangweiye/markdown/disables' | 'jiangweiye/node/rules' | 'jiangweiye/perfectionist/setup' | 'jiangweiye/react/setup' | 'jiangweiye/react/rules' | 'jiangweiye/solid/setup' | 'jiangweiye/solid/rules' | 'jiangweiye/sort/package-json' | 'jiangweiye/stylistic/rules' | 'jiangweiye/svelte/setup' | 'jiangweiye/svelte/rules' | 'jiangweiye/test/setup' | 'jiangweiye/test/rules' | 'jiangweiye/toml/setup' | 'jiangweiye/toml/rules' | 'jiangweiye/regexp/rules' | 'jiangweiye/typescript/setup' | 'jiangweiye/typescript/parser' | 'jiangweiye/typescript/rules' | 'jiangweiye/unicorn/rules' | 'jiangweiye/unocss' | 'jiangweiye/vue/setup' | 'jiangweiye/vue/rules' | 'jiangweiye/yaml/setup' | 'jiangweiye/yaml/rules'
 ...
 */
declare function eslint(options?: OptionsConfig & Omit<TypedFlatConfigItem, 'files'>, ...userConfigs: Awaitable<TypedFlatConfigItem | TypedFlatConfigItem[] | FlatConfigComposer<any, any> | Linter.Config[]>[]): FlatConfigComposer<TypedFlatConfigItem, ConfigNames>;
