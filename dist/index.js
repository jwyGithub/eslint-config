...
function toPath2(urlOrPath) {
  return urlOrPath instanceof URL ? fileURLToPath22(urlOrPath) : urlOrPath;
}
...
var import_ez_spawn, __defProp2, __name, Node, Queue, EndError, testElement, finder, typeMappings, matchType, toPath, findUpStop, AGENTS, LOCKS;
var init_dist = __esm({
  "node_modules/.pnpm/@jiangweiye+install-pkg@0.0.0/node_modules/@jiangweiye/install-pkg/dist/index.js"() {
    "use strict";
    init_esm_shims();
    ...
    toPath = /* @__PURE__ */ __name((urlOrPath) => urlOrPath instanceof URL ? fileURLToPath2(urlOrPath) : urlOrPath, "toPath");
...
var CWD, cjsRequire, EXTENSIONS;
var init_constants = __esm({
  "node_modules/.pnpm/@pkgr+core@0.1.1/node_modules/@pkgr/core/lib/constants.js"() {
    "use strict";
    init_esm_shims();
    CWD = process.cwd();
    cjsRequire = typeof __require === "undefined" ? createRequire(import.meta.url) : __require;
...
var tryPkg, isPkgAvailable, tryFile, tryExtensions, findUp2;
  ...
  "node_modules/.pnpm/@pkgr+core@0.1.1/node_modules/@pkgr/core/lib/helpers.js"() {
    ...
    tryFile = (filePath, includeDir = false) => {
      if (typeof filePath === "string") {
        return fs3.existsSync(filePath) && (includeDir || fs3.statSync(filePath).isFile()) ? filePath : "";
      }
    ...
    findUp2 = (searchEntry, searchFileOrIncludeDir, includeDir) => {
      console.assert(path5.isAbsolute(searchEntry));
      if (!tryFile(searchEntry, true) || searchEntry !== CWD && !searchEntry.startsWith(CWD + path5.sep)) {
        return "";
      }
      searchEntry = path5.resolve(fs3.statSync(searchEntry).isDirectory() ? searchEntry : path5.resolve(searchEntry, ".."));
      const isSearchFile = typeof searchFileOrIncludeDir === "string";
      const searchFile = isSearchFile ? searchFileOrIncludeDir : "package.json";
      do {
        const searched = tryFile(path5.resolve(searchEntry, searchFile), isSearchFile && includeDir);
        if (searched) {
          return searched;
        }
        searchEntry = path5.resolve(searchEntry, "..");
      } while (searchEntry === CWD || searchEntry.startsWith(CWD + path5.sep));
      return "";
    };
  }
});
...
function createSyncFn(workerPath, timeoutOrOptions) {
  ...
  if (!path6.isAbsolute(workerPath)) {
...
var INT32_BYTES, TsRunner, NODE_OPTIONS, SYNCKIT_EXEC_ARGV, SYNCKIT_GLOBAL_SHIMS, SYNCKIT_TIMEOUT, SYNCKIT_TS_RUNNER, DEFAULT_TIMEOUT, DEFAULT_EXEC_ARGV, DEFAULT_TS_RUNNER, DEFAULT_GLOBAL_SHIMS, DEFAULT_GLOBAL_SHIMS_PRESET, MTS_SUPPORTED_NODE_VERSION, syncFnCache, cjsRequire2, dataUrl, isFile, setupTsRunner, md5Hash, encodeImportModule, _generateGlobals, globalsCache, tmpdir, _dirname, sharedBuffer, sharedBufferView, generateGlobals;
var init_lib2 = __esm({
  "node_modules/.pnpm/synckit@0.9.0/node_modules/synckit/lib/index.js"() {
    "use strict";
    init_esm_shims();
    ...
    cjsRequire2 = typeof __require === "undefined" ? createRequire2(import.meta.url) : __require;
    dataUrl = (code) => new URL(`data:text/javascript,${encodeURIComponent(code)}`);
    isFile = (path7) => {
      var _a;
      try {
        return !!((_a = fs4.statSync(path7, { throwIfNoEntry: false })) === null || _a === void 0 ? void 0 : _a.isFile());
      } catch (_b) {
        return false;
      }
    };
    setupTsRunner = (workerPath, { execArgv, tsRunner }) => {
      let ext = path6.extname(workerPath);
      ...
      if (process.versions.pnp) {
        ...
        if (pnpApiPath && !(nodeOptions === null || nodeOptions === void 0 ? void 0 : nodeOptions.some((option, index2) => ["-r", "--require"].includes(option) && pnpApiPath === cjsRequire2.resolve(nodeOptions[index2 + 1]))) && !execArgv.includes(pnpApiPath)) {
          ...
          const pnpLoaderPath = path6.resolve(pnpApiPath, "../.pnp.loader.mjs");
    ...
    md5Hash = (text) => createHash("md5").update(text).digest("hex");
    encodeImportModule = (moduleNameOrGlobalShim, type = "import") => {
      ...
      const importStatement = type === "import" ? `import${globalName ? " " + (named === null ? "* as " + globalName : (named === null || named === void 0 ? void 0 : named.trim()) ? `{${named}}` : globalName) + " from" : ""} '${path6.isAbsolute(moduleName) ? String(pathToFileURL(moduleName)) : moduleName}'` : `${globalName ? "const " + ((named === null || named === void 0 ? void 0 : named.trim()) ? `{${named}}` : globalName) + "=" : ""}require('${moduleName.replace(/\\/g, "\\\\")}')`;
      if (!globalName) {
    ...
    _dirname = typeof __dirname === "undefined" ? path6.dirname(fileURLToPath3(import.meta.url)) : __dirname;
    generateGlobals = (workerPath, globalShims, type = "import") => {
      ...
      if (type === "import") {
        if (!tmpdir) {
          tmpdir = path6.resolve(findUp2(_dirname), "../node_modules/.synckit");
        }
        fs4.mkdirSync(tmpdir, { recursive: true });
        filepath = path6.resolve(tmpdir, md5Hash(workerPath) + ".mjs");
    ...
    var ReferenceTracker = class {
      ...
      *iterateCjsReferences(traceMap) {
        for (const { node: node2 } of this.iterateGlobalReferences(requireCall)) {
          ...
          yield* this._iteratePropertyReferences(node2, path7, nextTraceMap);
        }
      }
      /**
      ...
      *iterateEsmReferences(traceMap) {
        ...
        for (const node2 of programNode.body) {
          ...
          const path7 = [moduleId];
          if (nextTraceMap[READ]) {
            yield { node: node2, path: path7, type: READ, info: nextTraceMap[READ] };
          }
       ...
       * @returns {IterableIterator<{node:Node,path:string[],type:symbol,info:any}>} The iterator to iterate references.
       */
      *_iterateVariableReferences(variable, path7, traceMap, shouldReport) {
        ...
        try {
          for (const reference of variable.references) {
            ...
            if (shouldReport && traceMap[READ]) {
              yield { node: node2, path: path7, type: READ, info: traceMap[READ] };
            }
            yield* this._iteratePropertyReferences(node2, path7, traceMap);
          }
        } finally {
       ...
       */
      //eslint-disable-next-line complexity
      *_iteratePropertyReferences(rootNode, path7, traceMap) {
        let node2 = rootNode;
        ...
        if (parent.type === "CallExpression") {
          if (parent.callee === node2 && traceMap[CALL]) {
            yield { node: parent, path: path7, type: CALL, info: traceMap[CALL] };
          }
          return;
        }
        ...
        if (parent.type === "AssignmentExpression") {
          if (parent.right === node2) {
            yield* this._iterateLhsReferences(parent.left, path7, traceMap);
            yield* this._iteratePropertyReferences(parent, path7, traceMap);
          }
          return;
        }
        ...
        if (parent.type === "VariableDeclarator") {
          if (parent.init === node2) {
            yield* this._iterateLhsReferences(parent.id, path7, traceMap);
          }
        }
      }
      /**
       ...
       * @returns {IterableIterator<{node:Node,path:string[],type:symbol,info:any}>} The iterator to iterate references.
       */
      *_iterateLhsReferences(patternNode, path7, traceMap) {
        ...
        if (patternNode.type === "ObjectPattern") {
          for (const property of patternNode.properties) {
            ...
            const nextPath = path7.concat(key);
            const nextTraceMap = traceMap[key];
            if (nextTraceMap[READ]) {
              yield {
                node: property,
        ...
        if (patternNode.type === "AssignmentPattern") {
          yield* this._iterateLhsReferences(patternNode.left, path7, traceMap);
        }
      }
      /**
       ...
       * @returns {IterableIterator<{node:Node,path:string[],type:symbol,info:any}>} The iterator to iterate references.
       */
      *_iterateImportReferences(specifierNode, path7, traceMap) {
...
var require_context = __commonJS({
  "node_modules/.pnpm/@typescript-eslint+utils@7.10.0_eslint@8.57.0_typescript@5.4.5/node_modules/@typescript-eslint/utils/dist/eslint-utils/context.js"(exports) {
    ...
    function getFilename2(context) {
      return context.filename;
    }
    exports.getFilename = getFilename2;
...
var init_dirs = __esm({
  "node_modules/.pnpm/@unocss+eslint-plugin@0.60.3_eslint@8.57.0_typescript@5.4.5/node_modules/@unocss/eslint-plugin/dist/dirs.mjs"() {
    "use strict";
    init_esm_shims();
    distDir = fileURLToPath4(new URL("../dist", import.meta.url));
  }
});
...
var import_utils13, configsRecommended, syncAction, createRule, IGNORE_ATTRIBUTES, orderAttributify, CLASS_FIELDS, AST_NODES_WITH_QUOTES, order, blocklist, enforceClassCompile, plugin, configsFlat, index;
var init_dist2 = __esm({
  "node_modules/.pnpm/@unocss+eslint-plugin@0.60.3_eslint@8.57.0_typescript@5.4.5/node_modules/@unocss/eslint-plugin/dist/index.mjs"() {
    ...
    syncAction = createSyncFn(join(distDir, "worker.mjs"));
...
async function ensurePackages(packages) {
  if (process4.env.CI || process4.stdout.isTTY === false)
    return;
...
function eslint(options = {}, ...userConfigs) {
  const {
    ...
    isInEditor = !!((process6.env.VSCODE_PID || process6.env.VSCODE_CWD || process6.env.JETBRAINS_IDE || process6.env.VIM) && !process6.env.CI),
  ...
  if (enableGitignore) {
    ...
    else if (fs5.existsSync(".gitignore"))
