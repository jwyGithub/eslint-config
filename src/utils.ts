...
const isCwdInScope = isPackageExists('@jawyn/eslint-config');
 ...
 * @example
 * ```ts
 * import { renameRules } from '@jawyn/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@jawyn/eslint-config'
