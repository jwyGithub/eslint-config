...
export async function markdown(options: OptionsFiles & OptionsComponentExts & OptionsMarkdown = {}): Promise<TypedFlatConfigItem[]> {
    ...
    return [
        ...
        },
        {
            ...
            name: 'jawyn/markdown/parser'
        },
        {
            files,
            name: 'jawyn/markdown/rules',
            rules: {
        ...
        {
            files,
            name: 'jawyn/markdown/disables/markdown',
            rules: {
        ...
        },
        {
            ...
            name: 'jawyn/markdown/disables/code',
            rules: {
