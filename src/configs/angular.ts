...
export async function angular(options: OptionsOverrides = {}): Promise<TypedFlatConfigItem[]> {
    const { overrides = {} } = options;

    await ensurePackages(['@angular-eslint/eslint-plugin', '@angular-eslint/eslint-plugin-template', '@angular-eslint/template-parser']);
    ...
    return [
        ...
        },
        {
            ...
            name: 'jawyn/angular/rules/template',
            rules: {
