...
export type ConfigNames = 'janone/astro/setup' | 'janone/astro/rules' | 'janone/eslint-comments/rules' | 'janone/formatter/setup' | 'janone/imports/rules' | 'janone/javascript/setup' | 'janone/javascript/rules' | 'janone/jsx/setup' | 'janone/jsdoc/rules' | 'janone/jsonc/setup' | 'janone/jsonc/rules' | 'janone/markdown/setup' | 'janone/markdown/processor' | 'janone/markdown/parser' | 'janone/markdown/disables' | 'janone/node/rules' | 'janone/perfectionist/setup' | 'janone/nextjs/setup' | 'janone/nextjs/rules' | 'janone/react/setup' | 'janone/react/rules' | 'janone/solid/setup' | 'janone/solid/rules' | 'janone/sort/package-json' | 'janone/stylistic/rules' | 'janone/svelte/setup' | 'janone/svelte/rules' | 'janone/test/setup' | 'janone/test/rules' | 'janone/toml/setup' | 'janone/toml/rules' | 'janone/regexp/rules' | 'janone/typescript/setup' | 'janone/typescript/parser' | 'janone/typescript/rules' | 'janone/unicorn/rules' | 'janone/unocss' | 'janone/vue/setup' | 'janone/vue/rules' | 'janone/yaml/setup' | 'janone/yaml/rules' | 'janone/yaml/pnpm-workspace'
