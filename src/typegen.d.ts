...
export type ConfigNames = 'jawyn/gitignore' | 'jawyn/ignores' | 'jawyn/javascript/setup' | 'jawyn/javascript/rules' | 'jawyn/eslint-comments/rules' | 'jawyn/command/rules' | 'jawyn/perfectionist/setup' | 'jawyn/node/setup' | 'jawyn/node/rules' | 'jawyn/jsdoc/setup' | 'jawyn/jsdoc/rules' | 'jawyn/imports/rules' | 'jawyn/e18e/rules' | 'jawyn/unicorn/rules' | 'jawyn/jsx/setup' | 'jawyn/typescript/setup' | 'jawyn/typescript/parser' | 'jawyn/typescript/type-aware-parser' | 'jawyn/typescript/rules' | 'jawyn/typescript/rules-type-aware' | 'jawyn/typescript/erasable-syntax-only' | 'jawyn/stylistic/rules' | 'jawyn/regexp/rules' | 'jawyn/test/setup' | 'jawyn/test/rules' | 'jawyn/vue/setup' | 'jawyn/vue/rules' | 'jawyn/react/setup' | 'jawyn/react/rules' | 'jawyn/react/typescript' | 'jawyn/react/type-aware-rules' | 'jawyn/nextjs/setup' | 'jawyn/nextjs/rules' | 'jawyn/solid/setup' | 'jawyn/solid/rules' | 'jawyn/svelte/setup' | 'jawyn/svelte/rules' | 'jawyn/unocss' | 'jawyn/astro/setup' | 'jawyn/astro/rules' | 'jawyn/angular/setup' | 'jawyn/angular/rules/ts' | 'jawyn/angular/rules/template' | 'jawyn/jsonc/setup' | 'jawyn/jsonc/rules' | 'jawyn/sort/package-json' | 'jawyn/sort/tsconfig-json' | 'jawyn/pnpm/package-json' | 'jawyn/pnpm/pnpm-workspace-yaml' | 'jawyn/pnpm/pnpm-workspace-yaml-sort' | 'jawyn/yaml/setup' | 'jawyn/yaml/rules' | 'jawyn/toml/setup' | 'jawyn/toml/rules' | 'jawyn/markdown/setup' | 'jawyn/markdown/processor' | 'jawyn/markdown/parser' | 'jawyn/markdown/rules' | 'jawyn/markdown/disables/markdown' | 'jawyn/markdown/disables/code' | 'jawyn/formatter/setup' | 'jawyn/formatter/css' | 'jawyn/formatter/scss' | 'jawyn/formatter/less' | 'jawyn/formatter/html' | 'jawyn/formatter/xml' | 'jawyn/formatter/svg' | 'jawyn/formatter/markdown' | 'jawyn/formatter/astro' | 'jawyn/formatter/astro/disables' | 'jawyn/formatter/graphql' | 'jawyn/disables/scripts' | 'jawyn/disables/cli' | 'jawyn/disables/bin' | 'jawyn/disables/dts' | 'jawyn/disables/cjs' | 'jawyn/disables/config-files'
